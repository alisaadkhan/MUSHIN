...
@keyframes hub-pulse{0%,100%{box-shadow:0 0 0 0 rgba(168,85,247,0.4),0 0 32px rgba(168,85,247,0.2)}50%{box-shadow:0 0 0 12px rgba(168,85,247,0),0 0 48px rgba(168,85,247,0.35)}}
      ...
      <div className="space-y-0">
        {[{ l: 'Followers', v: '421K' }, { l: 'Engagement', v: '7.3%' }, { l: 'Fake Followers', v: '< 1.2%' }, { l: 'Total Views', v: '48M' }, { l: 'Avg Views', v: '114K' }].map((r, i, a) => (
          <div key={r.l} className={`flex justify-between py-2 ${i < a.length - 1 ? 'border-b border-white/[0.05]' : ''}`}>
            <span className="text-white/40">{r.l}</span><span className="text-white/70 font-semibold">{r.v}</span>
          </div>
        ))}
      </div>
        ...
        <div key={col} className="space-y-1.5">
          ...
          {items.map(({ n, av, bg2 }) => (
            <div key={n} className="flex items-center gap-1.5 rounded-lg p-2" style={{ background: bg, border: `1px solid ${border}` }}>
              <img src={`https://ui-avatars.com/api/?name=${av}&background=${bg2}&color=fff&bold=true&size=40&rounded=true`} alt={n}
...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="bg-[#060608] text-white">
      ...
      {/* BUILT FOR */}
      <SectionSpotlight aria-label="Built For section" className="py-16 px-6 border-b border-white/[0.06] z-20 bg-[#060608]">
      ...
      {/* BENTO STATS */}
      <SectionSpotlight aria-label="Statistics section" className="py-20 px-6 border-b border-white/[0.06] z-20 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
      ...
      {/* PROBLEM AGITATION */}
      <SectionSpotlight aria-label="Problem section" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
      ...
      {/* PLATFORMS */}
      <SectionSpotlight id="features" aria-label="Platform coverage section" className="py-24 px-6 z-20 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
      ...
      <SectionSpotlight aria-label="Intelligence engine section" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
      ...
      {/* 3 STEPS */}
      <SectionSpotlight aria-label="How it works section" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
      ...
      {/* ABOUT */}
      <SectionSpotlight id="about" aria-label="About section" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
      ...
      {/* OBJECTION HANDLING */}
      <SectionSpotlight aria-label="Objection handling section" className="py-20 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
      ...
      {/* PRICING */}
      <SectionSpotlight id="pricing" aria-label="Pricing section" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <div className="flex items-center justify-center gap-3 mt-6">
              <button onClick={() => setPricePeriod('m')} className={`text-xs font-bold px-4 py-1.5 rounded-full transition-all ${pricePeriod === 'm' ? 'bg-white text-black' : 'text-white/40 hover:text-white/70'}`}>Monthly</button>
              <button onClick={() => setPricePeriod('a')} className={`text-xs font-bold px-4 py-1.5 rounded-full transition-all ${pricePeriod === 'a' ? 'bg-white text-black' : 'text-white/40 hover:text-white/70'}`}>Annual <span className="text-green-400">−20%</span></button>
            </div>
          </div>
      ...
      {/* FAQ */}
      <SectionSpotlight aria-label="Frequently asked questions" className="py-24 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
      ...
      {/* CTA */}
      <SectionSpotlight aria-label="Call to action" className="py-32 px-6 border-t border-white/[0.06] z-20 bg-[#060608]">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
              <div>
                <div className="text-white/40 font-semibold uppercase tracking-widest text-[10px] mb-3">Product</div>
              ...
              <div>
                <div className="text-white/40 font-semibold uppercase tracking-widest text-[10px] mb-3">Company</div>
              ...
              <div>
                <div className="text-white/40 font-semibold uppercase tracking-widest text-[10px] mb-3">Legal</div>
