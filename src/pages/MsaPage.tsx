  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20 prose prose-invert prose-sm">
        ...
        <h2>1. Scope</h2>
        <p>This MSA forms the overarching legal framework governing the relationship between MUSHIN and our Enterprise clients. Specific deliverables and pricing are defined in individual Statements of Work (SOW) or Order Forms.</p>

        <h2>2. Warranties</h2>
        <p>MUSHIN warrants that the Services will be performed in a professional and workmanlike manner in accordance with industry standards.</p>

        <h2>3. Dispute Resolution</h2>
        <p>Any disputes arising under this MSA shall be resolved through binding arbitration in Karachi, Pakistan, under the rules of the local arbitration association, before resorting to litigation.</p>
      </main>
