  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20 prose prose-invert prose-sm">
        ...
        <p>MUSHIN grants you a revocable, non-exclusive, non-transferable, limited license to download, install, and use the application solely for your internal business operations strictly in accordance with the terms of this Agreement.</p>

        <h2>2. Restrictions</h2>
        <p>You agree not to modify, reverse engineer, decompile, or disassemble the platform. You may not use the platform for any illegal purpose or to violate any laws in your jurisdiction.</p>

        <h2>3. Intellectual Property</h2>
        <p>The platform, including all associated intellectual property rights, remains the exclusive property of MUSHIN and its licensors.</p>
      </main>
