      ...
      <div className="glass-card w-full max-w-md space-y-6 p-8 relative z-10">
        ...
        {mode === "sign-in" && (
          <form onSubmit={handleSignIn} className="space-y-4">
            <h2 className="text-center text-lg font-semibold text-foreground">Welcome back</h2>
        ...
        {mode === "sign-up" && (
          <form onSubmit={handleSignUp} className="space-y-4">
            <h2 className="text-center text-lg font-semibold text-foreground">Create your account</h2>
            <div className="space-y-2">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="you@example.com" />
            </div>
