...
export const CampaignReport = forwardRef<HTMLDivElement, CampaignReportProps>(
  ({ campaign, stages, cards, outreachEntries }, ref) => {
    ...
    return (
      <div ref={ref} className="p-8 bg-background text-foreground print:text-black print:bg-white max-w-4xl mx-auto">
        <style>{`
          @media print {
        ...
        <div className="campaign-report space-y-8">
          ...
          <div className="text-xs text-muted-foreground text-center pt-4 border-t">
            Generated by InfluenceIQ on {new Date().toLocaleDateString()}
          </div>
        </div>
      </div>
    );
