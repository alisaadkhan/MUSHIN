...
export function SignInCard2() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    setTimeout(() => {
        setIsLoading(false);
        window.location.href = '/admin'; // Redirect to admin dashboard on mock successful login
    }, 2000);
  };
            ...
            />
              ...
              <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                ...
                <div className="text-center space-y-1 mb-5">
                  ...
                  >
                    <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-400 to-purple-600">S</span>
                  ...
                  <motion.div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg">
                        ...
                        <Input
                          type="email"
                          placeholder="Admin / Support Email"
                          value={email}
